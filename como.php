		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3 noespacio cuadros">
				...
				<ul>
					...
					<li>Supervisión, remediación y recuperación de activos tangibles e intangibles.</li>
					<li>Respuesta e investigación a violaciones a la propiedad intelectual y divulgación de datos.</li>
					<li>Seguridad a las personas y a los activos.</li>
				</ul>
			</div>
			<div class="col-xs-12 col-sm-4 noespacio">
				<img src="img/img-como2.jpg" class="imagenes" alt="">
			</div>
		</div>
		<div class="col-xs-12">
			<hr class="separador">
