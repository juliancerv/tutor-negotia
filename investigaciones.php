...
<body>
	...
	<div class="container">
		<div class="row investigaciones">
			...
			<p>&nbsp;</p>
				<ul>
					<li><a href="#">Investigaciones Internas y sobre Fraude</a></li>
					<li><a href="#">Investigaciones Financieras</a></li>
					<li><a href="#">Investigaciones Cibernéticas</a></li>
					<li><a href="#">Búsquedas yRecuperación de Activos</a></li>
					<li><a href="#">Investigaciones Reglamentarias</a></li>
					<li><a href="#">Controles</a></li>
					<li><a href="#">Litigios y Conflictos</a></li>
					<li><a href="#">Uso debido de la Propiedad Intelectual</a></li>
				</ul>
			<p>&nbsp;</p>
			</div>
			<div class="col-xs-12 col-sm-5 noespacio top">
				<div class="cuadro-azul">
					...
					<p class="texto">El fraude y las irregularidades financieras son algunos de los problemas más complejos y exigentes a los que se enfrentan actualmente las empresas.</p>
				</div>
			...
			<div class="col-xs-12 col-sm-4 noespacio top2">
				...
				<div class="col-xs-6 col-sm-6">
					<a href="http://www.segman.com/index.html">
						...
						<p class="titulos">Tecnología<br>de detección</p>
					</a>
				</div>
				<div class="col-xs-6 col-sm-6">
