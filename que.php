		...
		<div class="row">
			...
			<br>
				<ul>
					...
					<li>Repuesta a la vulnerabilidad e infracción de datos e información.</li>
					<li>Gestión de riesgos de seguridad, Seguridad física y transportación.</li>
			...
			<div class="col-xs-12 col-sm-4 noespacio">
				<img src="img/img-que2.jpg" class="imagenes" alt="">
			</div>
		</div>
		<div class="col-xs-12">
			<hr class="separador">
